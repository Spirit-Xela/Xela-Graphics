...
void XelaWindow::captureMouse() {
	//Capture cursor.
	glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
}
void XelaWindow::hideMouse() {
	//Hide cursor.
	glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_HIDDEN);
}
void XelaWindow::showMouse() {
	//Show cursor.
...
void XelaWindow::setAlwaysOnTop(bool top) {
	glfwSetWindowAttrib(window, GLFW_FLOATING, top);
#ifdef XELA_DEBUG_WINDOW
	std::cout << "[Message][XelaWindow] Set " << winTitle << " Always on Top status to: " << top << std::endl;
#endif
}
void XelaWindow::setOpacity(float opa) {
